...
Alternatively, you can download the predictions of the test-set (inside `predictions.zip`) from mendeley data (extract into `/StomaDet/data`) and run the following command.
```
